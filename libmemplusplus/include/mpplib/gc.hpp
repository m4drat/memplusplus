...
namespace mpp {
    ...
    protected:
         ...
         * 
         * All GcPtr's that are currently used in program adds to this list, to keep track of them.
         */
    ...
    public:
         ...
         * After that, it will move all data to newly created arena, updating corresponding gcptr's.
         * And in the end it will destroy unused arenas.
